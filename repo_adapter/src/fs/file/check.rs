...
impl FileCheckPort for FileCheckAdapter {
    ...
    async fn check_file_exists(
        ...
        tracing::info!("[🔌 ADAPTER] - ✅️ 文件存在检查: file_id={}, exists={}", file_id, exists);
        Ok(exists)
    }
    ...
    async fn check_file_available(
        ...
        tracing::info!("[🔌 ADAPTER] - ✅️ 文件可用检查: file_id={}, available={}", file_id, available);
        Ok(available)
    }
    ...
    async fn check_file_owner(
        ...
        tracing::info!("[🔌 ADAPTER] - ✅️ 文件所有权检查: uid={}, file_id={}, is_owner={}", uid, file_id, is_owner);
        Ok(is_owner)
    }
}
