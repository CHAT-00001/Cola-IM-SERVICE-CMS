// repo_adapter/src/auth/identity/check.rs
// 🔌 适配器 - AUTH - 身份识别 - 检查
...
use port::auth::identity::check::IdentityCheckPort;
...
pub struct IdentityCheckAdapter;

#[async_trait]
impl IdentityCheckPort for IdentityCheckAdapter {
    //
