...
use cola_data::cola_gis::port::ColaGisPort;
use cola_data::cola_im::port::ColaImPort;
use cola_data::cola_live::port::ColaLivePort;
use cola_data::cola_market::port::ColaMarketPort;
use cola_data::cola_music::port::ColaMusicPort;
use cola_data::cola_three::port::ColaThreePort;
use cola_data::cola_user::port::ColaUserPort;
use cola_data::cola_user::port::ban::BanPort;
use cola_data::cola_user::port::black::BlackPort;
use cola_data::cola_user::port::follow::FollowPort;
use cola_data::cola_user::port::friend::FriendPort;
use cola_data::cola_user::port::role::RolePort;
use cola_data::cola_user::port::share::SharePort;
use cola_data::cola_user::port::user::UserPort;
use cola_data::cola_user::port::view::ViewPort;
use cola_data::cola_user::port::vip::VipPort;
use cola_data::cola_video::port::ColaVideoPort;
use cola_data::cola_video::port::buy::BuyPort;
use cola_data::cola_video::port::collect::CollectPort;
use cola_data::cola_video::port::comment::CommentPort;
use cola_data::cola_video::port::danmaku::DanmakuPort;
use cola_data::cola_video::port::dislike::DislikePort;
use cola_data::cola_video::port::hotlist::HotlistPort;
use cola_data::cola_video::port::like::LikePort;
use cola_data::cola_video::port::recommend::RecommendPort;
use cola_data::cola_video::port::report::ReportPort;
use cola_data::cola_video::port::share::VideoSharePort;
use cola_data::cola_video::port::video::VideoPort;
use cola_data::cola_video::port::view::VideoViewPort;
use std::sync::Arc;
