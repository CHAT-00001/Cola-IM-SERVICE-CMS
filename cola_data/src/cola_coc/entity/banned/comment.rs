// cola_data/src/new/entity/banned/download  --
// 数据 - VIDEO - entity - banned - 评论
// 2026/8/1 14:50
...
/// # [ENTITY] - 短视频 用户 封禁 评论 实体
/// * `pg schema`: `cola_video`
/// * `table name`: `banned_comment`
#[derive(Debug, Clone, Default, FromRow, Serialize, Deserialize)]
pub struct VideoBannedCommentEntity {
    pub uid: i64,                          // 用户 ID
...
/// # [COLUMNS] - 数据表原始字段
/// * `desc`: `给SQLx提供的表字段映射`
pub const VIDEO_BANNED_COMMENT_COLUMNS: &str = r#"
