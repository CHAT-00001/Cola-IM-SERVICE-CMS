...
use crate::cola_live::entity::cate::class::LiveClassEntity; // 请根据你实际的 handler 路径微调
use chrono::Utc;
...
pub struct LiveClassCommand {
    ...
    pub status: Option<i16>,         // 状态: 0禁用 1启用
}
