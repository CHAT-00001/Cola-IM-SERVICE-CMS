// cola_live/command/cola_live  -- 数据中心 - LIVE - command - 直播流记录(场次)
// 2026/6/12 23:22
...
use crate::cola_live::entity::live_stream_record::LiveStreamRecordEntity;
...
impl LiveStreamRecordCommand {
    ...
    /// # 1. [CASE] - 新建
    /// * `desc`: 关联表结构，全自动计算并填充所有默认值，生成第一个干净合法的直播记录
    pub fn new(cmd: Self, push_domain: &str, play_domain_flv: &str) -> LiveStreamRecordEntity {
        ...
        let push_url = format!("rtmp://{}/cola_live/{}", push_domain, stream_name);
