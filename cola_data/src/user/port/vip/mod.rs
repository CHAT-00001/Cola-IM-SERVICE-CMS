// user/port/vip/mod.rs
// 用户 - port - 贵宾 - 模块
// 2026/8/5 23:33 Created.

////////

use crate::user::port::vip::add::VipAddPort;
use crate::user::port::vip::check::VipCheckPort;
use crate::user::port::vip::del::VipDelPort;
use crate::user::port::vip::get::VipGetPort;
use crate::user::port::vip::list::VipListPort;
use crate::user::port::vip::manage::VipManagePort;
use std::sync::Arc;
