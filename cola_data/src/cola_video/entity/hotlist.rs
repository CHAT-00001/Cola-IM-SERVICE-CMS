// cola_data/src/video/entity/hotlist.rs -- 数据 - VIDEO - entity - 上热门记录表
// 2026/9/11 17:28 Created.
...
/// # [CONSTANT] - 上热门记录表字段常量定义
pub const VIDEO_HOTLIST_COLUMNS: &str = "\
