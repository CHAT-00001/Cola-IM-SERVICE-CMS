// cola_video/port/cola_video/mod.rs
// 视频 - port - 视频 - 模块
...
use std::sync::Arc;
use crate::cola_video::port::video::add::{VideoAddPort};
use crate::cola_video::port::video::check::VideoCheckPort;
use crate::cola_video::port::video::del::VideoDelPort;
use crate::cola_video::port::video::get::VideoGetPort;
use crate::cola_video::port::video::list::VideoListPort;
use crate::cola_video::port::video::manage::VideoManagePort;
use crate::cola_video::port::video::stat::VideoStatPortt;
