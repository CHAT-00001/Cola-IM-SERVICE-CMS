// cola_video/port/share/mod.rs
// 视频 - port - 分享 - 模块
// 2026/8/5 15:15 Created.

////////

use crate::cola_video::port::share::add::VideoShareAddPort;
use crate::cola_video::port::share::check::VideoShareCheckPort;
use crate::cola_video::port::share::del::VideoShareDelPort;
use crate::cola_video::port::share::get::VideoShareGetPort;
use crate::cola_video::port::share::list::VideoShareListPort;
use crate::cola_video::port::share::manage::VideoShareManagePort;
use crate::cola_video::port::share::stat::VideoShareStatPort;
use std::sync::Arc;
