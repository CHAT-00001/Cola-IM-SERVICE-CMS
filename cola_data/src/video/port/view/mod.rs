// data/video/port/view/mod.rs
// 视频 - port - 浏览 - 模块
// 2026/8/5 14:32 Created.

////////

use crate::video::port::view::active::VideoViewActivePort;
use crate::video::port::view::add::VideoViewAddPort;
use crate::video::port::view::del::VideoViewDelPort;
use crate::video::port::view::get::VideoViewGetPort;
use crate::video::port::view::manage::VideoViewManagePort;
use crate::video::port::view::stat::VideoViewStatPort;
use std::sync::Arc;
use crate::video::port::view::list::VideoViewListPort;
