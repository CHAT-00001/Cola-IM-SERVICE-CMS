// cola_data/src/im/port/contact_request.rs  -- IM - port - 联系人请求
// 2026-07-07

use crate::im::command::contact_request::ContactRequestCommand;
use crate::im::info::contact_request::ContactRequestInfo;
