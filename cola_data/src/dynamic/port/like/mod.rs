// dynamic/port/like/mod.rs
// 动态 - port - 点赞 - 模块
// 2026/8/5 15:42 Created.

////////

use crate::dynamic::port::like::add::LikeAddPort;
use crate::dynamic::port::like::check::LikeCheckPort;
use crate::dynamic::port::like::del::LikeDelPort;
use crate::dynamic::port::like::get::LikeGetPort;
use crate::dynamic::port::like::list::LikeListPort;
use crate::dynamic::port::like::manage::LikeManagePort;
use crate::dynamic::port::like::stat::LikeStatPort;
use std::sync::Arc;
////////
