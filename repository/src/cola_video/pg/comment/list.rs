...
impl VideoCommentListRepo {
    ...
    pub async fn find_new_list(
        ...
        let pool = pg_pool();
        let query = format!(
            "SELECT {} FROM cola_video.comment WHERE status = 1 ORDER BY addtime DESC LIMIT $1 OFFSET $2",
    ...
    pub async fn find_hot_list(
        ...
        let pool = pg_pool();
        let query = format!(
            "SELECT {} FROM cola_video.comment WHERE status = 1 ORDER BY likes DESC, views DESC, addtime DESC LIMIT $1 OFFSET $2",
            VIDEO_COMMENT_COLUMNS
        );
    ...
    pub async fn find_list_by_user_id(
        ...
        let pool = pg_pool();
        let query = format!(
            "SELECT {} FROM \"cola_video\".\"comment\" WHERE uid = $1 AND status = 1 ORDER BY add_time DESC LIMIT $2 OFFSET $3",
            VIDEO_COMMENT_COLUMNS
        );
    ...
    pub async fn find_list_by_video_id(
        ...
        let pool = pg_pool();
        let query = format!(
            "SELECT {} FROM \"cola_video\".\"comment\" WHERE video_id = $1 AND status = 1 ORDER BY add_time DESC LIMIT $2 OFFSET $3",
            VIDEO_COMMENT_COLUMNS
        );
