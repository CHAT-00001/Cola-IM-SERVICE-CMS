// repository/src/three/pg/config_repo.rs  -- 仓储 - THREE - 统一配置 PG（遗留兼容）
// 2026/6/30


////////

use cola_data::three::entity::config::{ThreeConfigEntity, THREE_CONFIG_COLUMNS};
use crate::pg_pool;

////////

/// # [REPO] - 统一配置 仓储（three_config 表）
