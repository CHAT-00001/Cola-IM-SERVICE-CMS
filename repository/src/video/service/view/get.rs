// repository/src/video/service/view/get.rs
// 仓储 - VIDEO - service - view - get 获取
...
use crate::video::pg::video::get::VideoGetRepo;
use crate::video::pg::video::video::VideoRepo;

////////

/// # [VIEW SERVICE] - 视频 浏览 添加 服务
...
impl VideoViewAddService {
    ...
    pub async fn batch_get_videos_infos(
        ...
        let db_videos = VideoGetRepo::pg_find_by_ids(&ids)
            .await
    ...
    pub async fn batch_uids_get_videos_infos(
        ...
        // 1. 从 DB 捞出原始 Entity 列表
        let db_videos = VideoGetRepo::pg_find_list_by_uids(Option::from(uids), keyword, offset, limit)
            .await
            .map_err(|e| anyhow::anyhow!("[👤 SERVICE]: 批量获取视频 handler 列表失败: {}", e))?;
    ...
    pub async fn get_videos_infos_by_uid(
        ...
        // 1. 从 DB 捞出原始 Entity 列表
        let db_videos = VideoRepo::find_list_by_uids(Some(vec![uid]), keyword, offset, limit)
            .await
            .map_err(|e| anyhow::anyhow!("[👤 SERVICE]: 批量获取视频 handler 列表失败: {}", e))?;
