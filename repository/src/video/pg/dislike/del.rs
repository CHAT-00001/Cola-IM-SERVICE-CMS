// repository/src/video/pg/like/del.rs -- 仓储层 - VIDEO - PG - 点赞 - 删除仓储
// 2026/8/9 00:54 Created.
...
/// # [DELETE REPOSITORY] - 视频不喜欢删除仓储
/// * `desc`: `VIDEO - 不喜欢删除仓储`
pub struct VideoDislikeDelRepo;

// 构造实现
impl VideoDislikeDelRepo {
    //
