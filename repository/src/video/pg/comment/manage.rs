// repo/src/video/pg/comment/manage.rs -- VIDEO - PG - 评论 - 管理仓储
...
/// [MANAGE REPOSITORY] - 视频评论管理仓储
/// * `desc`: `VIDEO - Comment Manage Repository.`
pub struct VideoCommentManageRepo;

impl VideoCommentManageRepo {
    //
    ...
    pub async fn find_admin_dislike_record_list(
        ...
        // 构建目标实体查询
        let query = query_builder.build_query_as::<VideoCommentEntity>();
