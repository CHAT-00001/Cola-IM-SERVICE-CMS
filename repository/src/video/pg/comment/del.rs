// repository/src/video/pg/comment/del.rs -- VIDEO - PG - 评论 - 删除仓储
...
/// # [DELETE REPOSITORY] - 视频评论删除仓储
/// * `DESC`: `VIDEO - Comment Delete Repository.`
pub struct VideoCommentDeleteRepo;

// 构造实现
impl VideoCommentDeleteRepo {
    //
