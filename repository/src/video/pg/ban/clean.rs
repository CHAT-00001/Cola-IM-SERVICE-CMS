// repository/src/video/pg/ban/clean.rs -- 仓储 - VIDEO - PG - 封禁 - 清除仓储
// 2026/8/3 19:59 Created.
...
/// # [MANAGE REPOSITORY] - 视频封禁清除仓储
pub struct VideoBanCleanRepo;

// 构造函数
impl VideoBanCleanRepo {
    //
