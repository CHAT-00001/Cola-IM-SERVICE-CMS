// repository/src/cola_gis/service/get  -- 鏈嶅姟灞?- GIS 娴忚
// 2026/7/6

use crate::cola_gis::pg::poi::PoiRepo;
use crate::cola_gis::pg::view::GisViewRepo;
...
impl PoiViewService {
    ...
    pub async fn batch_uids_get_gis_infos(uids: Vec<i64>, keyword: Option<String>, offset: i64, limit: i64) -> Result<Vec<PoiInfo>, anyhow::Error> {
    ...
    pub async fn get_gis_infos_by_uid(user_id: i64, keyword: Option<String>, offset: i64, limit: i64) -> Result<Vec<PoiInfo>, anyhow::Error> {
        let entities = GisViewRepo::pg_find_new_list_by_uid(user_id, keyword, offset, limit).await?;
        Ok(entities.into_iter().map(PoiInfo::from_entity).collect())
    }
}
