// repository/src/cola_music/pg/cola_music/get.rs
// 仓储 - MUSIC - pg - cola_music - get 获取
...
use cola_data::cola_music::entity::music::MusicEntity;

////////

/// # [GET REPOSITORY] - 音乐 信息 获取 仓储
/// * `desc`: `音乐 信息 获取 仓储`
pub struct MusicItemGetRepo;

// 构造函数
impl MusicItemGetRepo {
    //
