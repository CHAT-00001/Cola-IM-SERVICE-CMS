// repository/src/cola_three/pg/stream_repo.rs  -- 仓储 - THREE - 直播推流配置 PG
// 2026/6/30 05:01

////////

use crate::pg_pool;
use cola_data::cola_three::entity::stream::{STREAM_CONFIG_COLUMNS, ThreeStreamEntity};
...
impl StreamRepo {
    ...
    pub async fn update_status(
        id: i64,
        status: i16,
    ) -> Result<Option<ThreeStreamEntity>, sqlx::Error> {
        let pool = pg_pool();
        let query = format!(
