...
impl VideoCollectGetService {
    ...
    pub async fn get_collect_ids_by_user_id(
        ...
        let collect_ids = CollectGetRepo::find_video_ids_by_user_id(user_id, limit, offset).await?;
    ...
    pub async fn get_collect_records_by_video_id(
        ...
        let records =
            CollectGetRepo::find_collect_records_by_video_id(video_id, limit, offset).await?;
