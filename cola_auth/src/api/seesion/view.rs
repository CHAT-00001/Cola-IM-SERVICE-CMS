...
use crate::case::session::del::SessionDelCase;
...
/// # [VIEW HANDLER] - 会话 浏览接口
/// * `desc`: `会话浏览接口`
pub struct SessionViewApi;
...
impl SessionViewApi {
    ...
    pub async fn handler_session_sign_out(
        ...
        match SessionDelCase::case_logout(uid, session_id, device_id).await {
    ...
    pub async fn handler_refresh_token(query: ApiQuery) -> AppData<AccessTokenInfo> {
        ...
        match SessionStateCase::case_refresh(r_token).await {
