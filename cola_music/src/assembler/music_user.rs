// cola_music/src/assembler/music_user.rs -- 🎶 可乐音乐 - 组装 - 用户响应体
// 2026/8/31 16:58 Created.
...
/// # [BUILD] - 构建单音乐用户响应函数
pub async fn build_music_user_single_response(
...
/// # [BUILD] - 构建多音乐用户列表响应体
pub async fn build_music_user_list_response(
    infos: Vec<MusicInfo>,
    _current_uid: Option<i64>,
    page: i64,
    qty: i64,
