// gate_http/src/http/auth/router2 -- 路由器 AUTH相关
// 2026-01-02 10:25

//////

use actix_web::{web};
use crate::http::auth::handler::login::{apple_login, email_login, google_login, phone_login, wechat_login};
use crate::http::auth::handler::logout::logout;
use crate::http::auth::handler::refresh::refresh_token;
use crate::http::auth::handler::send::{send_email_code, send_msm_code};
