...
/// # [ROUTER] - 市场 - 路由器
pub fn market_router(cfg: &mut web::ServiceConfig) {
    cfg.service(
        // by
        // * /new/xxxx
        web::scope("/market")
            ...
            // 网关
            .route("/gateway", web::get().to(market_gateway))
            .route("/gateway", web::post().to(market_gateway)),
    );
}
