// repo/src/three/pg/three_type.rs  -- 仓储 - THREE - 服务类型 PG
// 2026/6/30 05:00

////////

use crate::pg_pool;
use cola_data::three::entity::three_type::{THREE_TYPE_COLUMNS, ThreeTypeEntity};
...
impl TypeRepo {
    ...
    pub async fn upsert(
        ...
        sort: i16,
        status: i16,
    ) -> Result<ThreeTypeEntity, sqlx::Error> {
        let pool = pg_pool();
        let query = format!(
