// port/src/cola_market/collect/mod.rs
// ⏩️ 端口 - MARKET - 商品收藏 - 模块
// 2026/6/10 08:23 Created.

////////

use crate::cola_market::collect::add::GoodsCollectAddPort;
use crate::cola_market::collect::check::GoodsCollectCheckPort;
use crate::cola_market::collect::del::GoodsCollectDelPort;
use crate::cola_market::collect::get::GoodsCollectGetPort;
use crate::cola_market::collect::list::GoodsCollectListPort;
use crate::cola_market::collect::manage::GoodsCollectManagePort;
use crate::cola_market::collect::stat::GoodsCollectStatPort;
use std::sync::Arc;
