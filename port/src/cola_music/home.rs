...
pub trait HomePort: Send + Sync {
    ...
    /// # 1. [PORT] - 最新
    async fn home_new(&self, uid: i64, limit: i64, offset: i64)
    -> anyhow::Result<(Vec<MusicInfo>)>;

    ////////

    /// # 2. [PORT] - 热门
    async fn home_hot(&self, uid: i64, limit: i64, offset: i64)
    -> anyhow::Result<(Vec<MusicInfo>)>;

    ////////

    /// # 3. [PORT] - 推荐
    async fn home_recommend(
        &self,
        uid: i64,
        limit: i64,
        offset: i64,
