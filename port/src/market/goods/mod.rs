...
use crate::market::goods::add::GoodsAddPort;
use crate::market::goods::check::GoodsCheckPort;
use crate::market::goods::delete::GoodsDeletePort;
use crate::market::goods::get::GoodsGetPort;
use crate::market::goods::list::GoodsListPort;
use crate::market::goods::manage::GoodsManagePort;
use crate::market::goods::stat::GoodsStatPort;
use std::sync::Arc;
